...
/**
 * Allocates available storage directories in a round robin manner to distribute the storage load evenly across all
 * directories. Even though the requested capacity is not considered, it will be the same for most complete SSTables.
