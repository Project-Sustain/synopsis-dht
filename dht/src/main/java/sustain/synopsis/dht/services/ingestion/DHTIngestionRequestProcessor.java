...
public class DHTIngestionRequestProcessor implements IngestionRequestProcessor {
    private final Logger logger = Logger.getLogger(DHTIngestionRequestProcessor.class);
    private final WriterPool writerPool;
    private final NodeStore nodeStore;

    public DHTIngestionRequestProcessor(NodeStore nodeStore) {
    ...
    @Override
    public CompletableFuture<TerminateSessionResponse> process(TerminateSessionRequest terminateSessionRequest) {
        ...
        return combineCompletableBinaryFutures(futures)
                .thenApply(status -> TerminateSessionResponse.newBuilder().setStatus(status).build());
    }
