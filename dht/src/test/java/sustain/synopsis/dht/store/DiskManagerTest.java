...
public class DiskManagerTest {
    ...
    void testProcessPath() throws StorageException, IOException {
        ...
        diskManager.processPath(mockFile);
        ...
        Assertions.assertNull(diskManager.processPath(mockFile));
        ...
        DiskManager.StorageDirectory directory = diskManager.processPath(mockFile);
        Assertions.assertNotNull(directory);
        Assertions.assertEquals("/a/b/c", directory.path);
        Assertions.assertEquals(100L, directory.availableCapacity);
    }
