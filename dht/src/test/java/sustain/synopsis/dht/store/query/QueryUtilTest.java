...
public class QueryUtilTest {
    ...
    void testMergeTemporalBracketsAsUnion() {
        List<Interval> brackets = new ArrayList<>(Arrays.asList(new Interval(0, 100), new Interval(200, 300),
                new Interval(250, 350), new Interval(340, 400), new Interval(380, 390)));
    ...
    void testEvaluateTemporalPredicateLessThan() throws QueryException {
        ...
        Assertions.assertEquals(new Interval(0, 1000), QueryUtil.evaluateTemporalPredicate(predicate, new Interval(0,
                2000)));
        Assertions.assertEquals(new Interval(0, 200), QueryUtil.evaluateTemporalPredicate(predicate, new Interval(0,
                200)));
        Assertions.assertEquals(new Interval(0, 1000), QueryUtil.evaluateTemporalPredicate(predicate, new Interval(0,
                1000)));
    ...
    void testEvaluateTemporalPredicateLessThanOrEqual() throws QueryException {
        ...
        Assertions.assertEquals(new Interval(0, 1001), QueryUtil.evaluateTemporalPredicate(predicate, new Interval(0,
                2000)));
        Assertions.assertEquals(new Interval(0, 200), QueryUtil.evaluateTemporalPredicate(predicate, new Interval(0,
                200)));
        Assertions.assertEquals(new Interval(0, 1000), QueryUtil.evaluateTemporalPredicate(predicate, new Interval(0,
                1000)));
        Assertions.assertEquals(new Interval(1000, 1001), QueryUtil.evaluateTemporalPredicate(predicate,
    ...
    void testEvaluateTemporalPredicateGreaterThan() throws QueryException {
        ...
        Assertions.assertEquals(new Interval(1001, 2000), QueryUtil.evaluateTemporalPredicate(predicate,
                new Interval(0, 2000)));
        Assertions.assertEquals(new Interval(1001, 2000), QueryUtil.evaluateTemporalPredicate(predicate,
                new Interval(1000, 2000)));
        Assertions.assertEquals(new Interval(1500, 2000), QueryUtil.evaluateTemporalPredicate(predicate,
                new Interval(1500, 2000)));
    ...
    void testEvaluateTemporalPredicateGreaterThanOrEqual() throws QueryException {
        ...
        Assertions.assertEquals(new Interval(1000, 2000), QueryUtil.evaluateTemporalPredicate(predicate,
                new Interval(0, 2000)));
        Assertions.assertEquals(new Interval(1000, 2000), QueryUtil.evaluateTemporalPredicate(predicate,
                new Interval(1000, 2000)));
        Assertions.assertEquals(new Interval(1500, 2000), QueryUtil.evaluateTemporalPredicate(predicate,
    ...
    void testEvaluateTemporalExpressionWithExpressions() throws QueryException {
        ...
        Assertions.assertThrows(QueryException.class,
                () -> QueryUtil.evaluateTemporalExpression(finalCombinedExpression, new Interval(0, 5000)));
    }
