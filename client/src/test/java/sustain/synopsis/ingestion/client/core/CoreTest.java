...
class CoreTest {
    ...
    void testTemporalQuantizer() {
        ...
        long[] returned = quantizer.getTemporalBoundaries(CommonUtil.localDateTimeToEpoch(ts1));
        long expectedUpperBoundary = CommonUtil.localDateTimeToEpoch(LocalDateTime.of(2019, Month.JANUARY, 12,
                                                                                      7, 0, 0));
        long expectedLowerBoundary = CommonUtil.localDateTimeToEpoch(LocalDateTime.of(2019, Month.JANUARY, 12,
                                                                                      6, 0, 0));
        ...
        returned = quantizer.getTemporalBoundaries(CommonUtil.localDateTimeToEpoch(ts1));
        expectedUpperBoundary = CommonUtil.localDateTimeToEpoch(LocalDateTime.of(2019, Month.JANUARY, 12, 4, 0, 0));
        Assertions.assertEquals(expectedUpperBoundary, returned[1]);

        // simulate a sparse observation
        ts1 = LocalDateTime.of(2019, Month.JANUARY, 12, 17, 21, 30);
        returned = quantizer.getTemporalBoundaries(CommonUtil.localDateTimeToEpoch(ts1));
        expectedUpperBoundary = CommonUtil.localDateTimeToEpoch(LocalDateTime.of(2019, Month.JANUARY, 12, 18, 0, 0));
        Assertions.assertEquals(expectedUpperBoundary, returned[1]);
